...
Правила DDD, CQRS и Hexagonal Clean Architecture вынесены в
[RFC: сохранение архитектуры](docs/rfc-architecture.md). Изменения, которые
нарушают эти инварианты, оформляются отдельным RFC до реализации.
...
Полная документация хранится в репозитории и синхронизируется в wiki.
Source of truth остается в Git: изменения документации проходят через обычный
review вместе с кодом.

- [Архитектура](docs/architecture.md)
- [Инфраструктура](docs/infrastructure.md)
- [RFC: сохранение архитектуры](docs/rfc-architecture.md)
